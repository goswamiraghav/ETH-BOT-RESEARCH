...
\cite{guo2018bitcoin} evaluated over 1,700 technical rules
...
\cite{detzel2023learning} combine machine learning with
...
Lento et al.\ \cite{lento2007combined} test combined
...
frequency. Menkhoff\ \cite{menkhoff2010technical}
documents widespread use of multi-timeframe technical
analysis among professional fund managers across 692
surveyed fund managers in 5 countries, providing
practitioner-level evidence that MTF analysis is a
standard tool in active portfolio management.
...
\bibitem{guo2018bitcoin}
T.~Guo and N.~Antulov-Fantulin,
``Predicting short-term Bitcoin price fluctuations
from buy and sell orders,''
\emph{arXiv preprint arXiv:1802.04065}, 2018.

\bibitem{detzel2023learning}
...
\bibitem{menkhoff2010technical}
L.~Menkhoff,
``The use of technical analysis by fund managers:
International evidence,''
\emph{Journal of Banking \& Finance}, vol.~34, no.~11,
pp.~2573--2586, 2010.
